...
export const tools: Tool[] = [
  ...
  { slug: "descript", name: "Descript", logo: "D", logoClass: "logo-indigo", category: "AI productivity", description: "AI-powered audio and video editing — edit your recordings the way you edit a document.", rating: 4.6, price: "From $16/month", highlights: ["Text-based audio & video editing", "Studio Sound and filler-word removal", "Built-in clips and captions"], bestFor: "Podcasters and video creators", affiliateUrl: "https://www.descript.com/" },
